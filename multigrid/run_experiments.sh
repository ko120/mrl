...
python main.py --algorithm MAPPO --mode ppo --seed 42 --wandb_project multigrid-ippo &
MAPPO_PID=$!

# Run IPPO (local obs only)
python main.py --algorithm IPPO --mode ppo --seed 42 --wandb_project multigrid-ippo &
IPPO_PID=$!
